...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionview>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<activerecord>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<activejob>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<actioncable>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<activestorage>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.1.5"])
      s.add_runtime_dependency(%q<railties>.freeze, ["= 6.1.5"])
      ...
      s.add_dependency(%q<activemodel>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<activerecord>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<actionmailer>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<activejob>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<actioncable>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<activestorage>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<actionmailbox>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<actiontext>.freeze, ["= 6.1.5"])
      s.add_dependency(%q<railties>.freeze, ["= 6.1.5"])
